...
const updateUser = async (req, res) => {
  try {
    ...
    if (new_username === user.username) {
      return res.status(400).json({ message: "You should enter a new username", data: null });
    }
    
    user = await User.findByIdAndUpdate(userid, { username: new_username }, { new: true });
...
export {updateEmail, updateUser, updatePassword, deleteUser };