...
import { createOffer, deleteOfferById, getAllOffers, getOfferById, updateOfferById } from "../controllers/offerControllers.js"

const offerRouter = Router();

offerRouter.route("/create").post(createOffer);

offerRouter.route("/getAll").get(getAllOffers);
